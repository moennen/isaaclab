...
def cube_quat_b(
    ...
    robot_quat_w = robot.data.root_quat_w  # (num_envs, 4)
    cube_pos_w = cube.data.root_pos_w      # (num_envs, 3)
    cube_quat_w = cube.data.root_quat_w    # (num_envs, 4)
...
def ee_state_b(
    ...
    # body_link_state_w: (num_envs, num_bodies, 13)
    ee_state_w = robot.data.body_link_state_w[:, ee_cfg.body_ids[0], :]  # (num_envs, 13)
