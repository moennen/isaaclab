...
DEFAULT_CONFIG = {
    ...
    "lift_height":           0.20,   # reward threshold: cube must exceed this z [m]
    ...
    "cube_half_height":      0.034,  # VBD cube: COM at cube_half(0.025)+particle_radius(0.009)=0.034m
                                     # so bottom particle layer sits at z=particle_radius (not inside ground)
