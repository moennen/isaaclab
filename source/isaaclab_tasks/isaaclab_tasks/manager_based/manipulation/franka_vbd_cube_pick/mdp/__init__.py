...
"""MDP components for the Franka VBD cube pick task."""
...
# Task-specific events (cube reset via VBD manager, not RigidObject).
from .events import reset_cube_pose_uniform
