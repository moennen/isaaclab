...
@configclass
class Dexsuite3dgProxyReorientEnvCfg(ManagerBasedEnvCfg):
    """Dexsuite 3dg proxy reorientation task definition, also the base definition for derivative Lift task and evaluation task"""
...
class Dexsuite3dgProxyLiftEnvCfg(Dexsuite3dgProxyReorientEnvCfg):
    """Dexsuite 3dg proxy lift task definition"""
...
class Dexsuite3dgProxyReorientEnvCfg_PLAY(Dexsuite3dgProxyReorientEnvCfg):
    """Dexsuite 3dg proxy reorientation task evaluation environment definition"""
...
class Dexsuite3dgProxyLiftEnvCfg_PLAY(Dexsuite3dgProxyLiftEnvCfg):
    """Dexsuite 3dg proxy lift task evaluation environment definition"""
