...
@configclass
class Dexsuite3dgProxyKukaAllegroPPOBaseRunnerCfg(RslRlOnPolicyRunnerCfg):
...
@configclass
class Dexsuite3dgProxyKukaAllegroPPORunnerCfg(PresetCfg):
    default = Dexsuite3dgProxyKukaAllegroPPOBaseRunnerCfg().replace(
        experiment_name="dexsuite_3dg_proxy_kuka_allegro",
    ...
    single_camera = Dexsuite3dgProxyKukaAllegroPPOBaseRunnerCfg().replace(
        experiment_name="dexsuite_3dg_proxy_kuka_allegro_single_camera",
    ...
    duo_camera = Dexsuite3dgProxyKukaAllegroPPOBaseRunnerCfg().replace(
        experiment_name="dexsuite_3dg_proxy_kuka_allegro_duo_camera",
        obs_groups={
