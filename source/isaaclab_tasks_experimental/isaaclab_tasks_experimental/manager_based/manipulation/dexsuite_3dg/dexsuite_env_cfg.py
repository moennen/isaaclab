...
class Dexsuite3dgLiftEnvCfg(Dexsuite3dgReorientEnvCfg):
    """Dexsuite 3dg lift task definition"""
...
class Dexsuite3dgReorientEnvCfg_PLAY(Dexsuite3dgReorientEnvCfg):
    """Dexsuite 3dg reorientation task evaluation environment definition"""
...
class Dexsuite3dgLiftEnvCfg_PLAY(Dexsuite3dgLiftEnvCfg):
    """Dexsuite 3dg lift task evaluation environment definition"""
